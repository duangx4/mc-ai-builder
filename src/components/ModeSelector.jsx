...
import { Zap, Sparkles, FileText, Rocket, Target, HelpCircle } from 'lucide-react';
    ...
    <>
      <div className="flex items-center gap-2 mb-3">
        ...
        <button
          ...
          className="ml-2 p-2 rounded-lg bg-neutral-800/50 text-neutral-400 hover:text-white hover:bg-neutral-700/50 border border-white/10 transition-all"
          title={language === 'zh' ? '查看模式介绍' : 'View mode descriptions'}
        >
